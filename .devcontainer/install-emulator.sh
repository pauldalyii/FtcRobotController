cd $ANDROID_HOME # Change to the Android SDK directory
wget https://redirector.gvt1.com/edgedl/android/repository/emulator-linux_x64-12367951.zip # Android emulator (not available through `sdkmanager` on arm64)
unzip emulator-linux_x64-12367951.zip # Unzip the emulator

cat <<EOF > emulator/package.xml
